...
if __name__ == '__main__':
    ...
    testDataDirPath = os.path.abspath(os.path.join(directory_path, '../resources/data/do_prediction'))
    doc_data, doc_labels = gensim_doc2vec_trainer.read_documents(testDataDirPath)
    # print(doc_labels)
